...
$SITE   = "http://0xf.fr"; // Full path to the script
$PAGE_CONTENT = "";
...
if (isset($_GET['p']))
{
  ...
  {
    $PAGE_CONTENT .= "This URL does not exist !";
  }
}
else if (isset($_POST['url']))
{
  ...
  {
    $PAGE_CONTENT .= '<h2>'. $SITE . '/' . $code .'</h2>';
  }
  else
  {
    $PAGE_CONTENT .= "Errors while shortening the submitted URL !";
  }
}
...
<div id="container">
  ...
  <h4>
    <a href="<?php echo $SOURCE ?>">Simple Url Shortener</a> <br />
    Minimalist PHP script using SQLite, GNU AGPL V3<br />
    &copy; 2010 Hyacinthe Cartiaux &lt;hyacinthe.cartiaux (a) free.fr&gt;
  </h4>
